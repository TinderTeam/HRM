...
DROP TABLE IF EXISTS `s_system_meta_data`;
...
DROP TABLE IF EXISTS `d_user_ext_attr`;
...
DROP TABLE IF EXISTS `s_system_function_set`;
...
DROP TABLE IF EXISTS `d_system_id_type`;
